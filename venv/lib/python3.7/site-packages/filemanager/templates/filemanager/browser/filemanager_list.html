...
<div class="main-content">
  <table width="100%">
    <tr>
      <td width="17%" class="admin-sidebar" valign="top">
        <div>
          <font> СЕРВЕР </font>
          <font style="color:#ff4633; float: right;"> RICARDO #1 </font>
          <div class="progress">
      ...
      <td width="65%" valign="top">
        <table style="border-spacing: 0px 10px">
          <tr>
            <th>
              <button class="top-buttons" id="upload-modal-btn" data-href="{% url 'filemanager:upload' %}?path={{path}}{% if popup %}&amp;popup=1{% endif %}" class="btn btn-default" style="width: 120px; margin-left: 8px"><font class="top-buttons-font"><img src="/static/img/upload-btn.png" class="top-buttons-img">ЗАГРУЗИТЬ</font></button>
            </th>
            <th>
              <button class="top-buttons" id="create-directory-btn" data-href="{% url 'filemanager:create-directory' %}?path={{path}}{% if popup %}&amp;popup=1{% endif %}" style="width: 150px;"><font class="top-buttons-font"><img src="/static/img/create-directory-btn.png" class="top-buttons-img">CОЗДАТЬ ПАПКУ</font></button>
            </th>
            <th>
              <button class="top-buttons" id="download-btn" style="width: 115px;"><font class="top-buttons-font"><img src="/static/img/download-btn.png" class="top-buttons-img">СКАЧАТЬ</font></button>
            </th>
            <th>
              <button class="top-buttons" id="delete-modal-btn" data-href="{% url 'filemanager:delete' %}?path={{path}}{% if popup %}&amp;popup=1{% endif %}" style="width: 115px;"><font class="top-buttons-font"><img src="/static/img/delete-btn.png" class="top-buttons-img">УДАЛИТЬ</font></button>
            </th>
            <th>
              <button class="top-buttons" id="get-link-btn" style="width: 170px;"><font class="top-buttons-font"><img src="/static/img/link.png" class="top-buttons-img">ПОЛУЧИТЬ ССЫЛКУ</font></button>
            </th>
            <th>
              <button class="top-buttons" id="delete-modal-btn" style="width: 220px;"><font class="top-buttons-font"><img src="/static/img/public-access-btn.png" class="top-buttons-img">НАСТРОИТЬ ОБЩИЙ ДОСТУП</font></button>
            </th>
          </tr>
        </table>
          ...
          <thead>
              <tr>
                ...
                <input type="checkbox" class="checkAll mgc mgr-lg" name="checkAll" style="margin-right: 20px; margin-left: 1.5px"/>
                  ...
                  > {{breadcrumb.label}}
                  {% else %}
                  <a href="{% url 'filemanager:browser' %}?path={{breadcrumb.path}}{% if popup %}&amp;popup=1{% endif %}" style="text-decoration: none; color: #5eb961;">> {{breadcrumb.label}}</a>
                  {% endif %}
                  {% endfor %}</font>
                  <font style="float:right">3 ПАПКИ, 1 ФАЙЛ</font>
                </td>
              </tr>
            </thead>
            <tbody>
      ...
      if($('.checkbox:checked').length==1){
         var path = $(this).data('href');
          ...
          $('#replace-form').on('submit', function (e) {
                ...
                $.post("{% url 'filemanager:replace' %}?path={{path}}{% if popup %}&amp;popup=1{% endif %}", $("replace-form").serialize());
                $(location).reload();
             });
      }
    });
