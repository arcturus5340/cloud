...
<div class="main-content">
  <table style="margin-left: 2px;margin-bottom: 10px">
    <tr>
      <th>
        <button class="top-buttons" id="save-to-cloud-btn" style="width: 207px"><font class="top-buttons-font"><img src="/static/img/save-to-cloud-btn.png" class="top-buttons-img">СОХРАНИТЬ В ОБЛАКО</font></button>
      </th>
      <th>
