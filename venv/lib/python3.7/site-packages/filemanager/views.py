...
from filemanager.forms import DirectoryCreateForm, RenameForm, ReplaceForm
...
class ReplaceView(FilemanagerMixin, FormView):
...
class BlockView(FilemanagerMixin, ListView):
    def post(self, request):
        self.fm.block(request.POST['path'])
        return HttpResponse('success')

class UnblockView(FilemanagerMixin, ListView):
    def post(self, request):
        self.fm.unblock(request.POST['path'])
        return HttpResponse('success')

class AccessUrlView(FilemanagerMixin, ListView):
    def post(self, request):
        self.fm.access_url(request.POST['path'])
        return HttpResponse('success')

class UnaccessUrlView(FilemanagerMixin, ListView):
    def post(self, request):
        self.fm.unaccess_url(request.POST['path'])
        return HttpResponse('success')

class SaveUrlView(FilemanagerMixin, ListView):
    def post(self, request):
        self.fm.save_url(request.POST['path'], request.POST['urls'])
        return HttpResponse('success')
